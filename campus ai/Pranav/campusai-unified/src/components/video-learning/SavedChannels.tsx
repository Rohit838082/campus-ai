...
import { getSavedChannels, CHANNELS, type Channel } from "../../lib/videoMockData";
  ...
  return (
    <section className="space-y-4 animate-fade-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        {saved.map((c, i) => (
          <div key={c.name} className="cursor-pointer" onClick={() => router.push(`/videos/channel/${encodeURIComponent(c.name)}`)}>
